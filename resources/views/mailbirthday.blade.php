<div style="width:100%; display:flex; background:#d1d1d11c; justify-content: center;">
    <div style="width: 100%; text-align: center;">
        ...
        <div id="footer" style="text-align: center;">
            <p style="font-size: 11px; color: #5a5353;">Khách sạn ABC <br>
            25 Ông Bích Khiêm, quận Hải Châu, TP. Đà Nẵng, Việt Nam <br>
            Tổng đài hỗ trợ khách hàng 1900 9999 <br><br>
            Email này được gửi từ hộp thư tự động và không nhận trả lời <br>
            Quý khách vui lòng liên hệ hoctrokt@gmail.com hoặc gọi đến số 1900 9999 để được hỗ trợ</p>
        </div>
    </div>
</div>